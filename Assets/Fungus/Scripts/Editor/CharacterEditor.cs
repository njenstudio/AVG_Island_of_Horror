...
namespace Fungus.EditorUtils
{
    ...
    public class CharacterEditor : Editor
    {
        ...
        protected SerializedProperty skeletonDataAssetProp;
        ...
        protected virtual void OnEnable()
        {
            ...
            skeletonDataAssetProp = serializedObject.FindProperty("skeletonDataAsset");
        ...
        public override void OnInspectorGUI() 
        {
            ...
            EditorGUILayout.PropertyField(skeletonDataAssetProp, new GUIContent("Skeleton Data Asset", "for display skeleton."));
