    ...
    public class WriterAudio : MonoBehaviour, IWriterListener
    {
        ...
        protected virtual void Awake()
        {
            ...
            if (SettingManager.instance!=null)
                targetAudioSource.outputAudioMixerGroup = SettingManager.instance.audioMixer.FindMatchingGroups("Master")[2];
        }
        ...
        public void OnGolbleStart(Writer w)
        {
        }

        public void OnGolbleResume(Writer w)
        {
        }
        #endregion
    }
