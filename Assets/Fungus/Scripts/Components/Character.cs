...
namespace Fungus
{
    ...
    public class Character : MonoBehaviour, ILocalizable, IComparer<Character>
    {
        ...
        /// <summary>
        /// SkeletonDataAsset to display when this character is showing.
        /// </summary>
        /// <value>The sound effect.</value>
        public virtual SkeletonDataAsset SkeletonDataAsset { get { return skeletonDataAsset; } }
