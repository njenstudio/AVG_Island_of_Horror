...
namespace Fungus
{
    ...
    public class MusicManager : MonoBehaviour
    {
        ...
        protected virtual void Awake()
        {
            ...
            {
                audioSourceMusic.outputAudioMixerGroup = SettingManager.instance.audioMixer.FindMatchingGroups("Master")[1];
                audioSourceAmbiance.outputAudioMixerGroup = SettingManager.instance.audioMixer.FindMatchingGroups("Master")[2];
                audioSourceSoundEffect.outputAudioMixerGroup = SettingManager.instance.audioMixer.FindMatchingGroups("Master")[2];
            }
        }
